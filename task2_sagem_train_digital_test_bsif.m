...
Train_All_Data_BSIF = Train_All_Data_SageBSIF
Train_All_Data_BSIF = num2cell(Train_All_Data_BSIF, 1)
Train_All_Label_BSIF = Train_All_Label_SageBSIF

Test_All_Data_BSIF = Test_All_Data_DigiBSIF
Test_All_Label_BSIF = Test_All_Label_DigiBSIF
...
save('data_task2_sagem_train_digital_test_bsif')