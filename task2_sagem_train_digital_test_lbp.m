...
Train_All_Data_LBP = Train_All_Data_SageLBP
Train_All_Data_LBP = num2cell(Train_All_Data_LBP, 1)
Train_All_Label_LBP = Train_All_Label_SageLBP

Test_All_Data_LBP = Test_All_Data_DigiLBP
Test_All_Label_LBP = Test_All_Label_DigiLBP
