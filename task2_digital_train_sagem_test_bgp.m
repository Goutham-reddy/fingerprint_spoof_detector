...
% BGP from digital is trained and LBP from sagem is tested

% combine BGP features data
Train_All_Data_BGP = Train_All_Data_DigiBGP
Train_All_Data_BGP = num2cell(Train_All_Data_BGP, 1)
Train_All_Label_BGP = Train_All_Label_DigiBGP

Test_All_Data_BGP = Test_All_Data_SageBGP
Test_All_Label_BGP = Test_All_Label_SageBGP
...
save('data_task2_digital_train_sagem_test_bgp.mat')